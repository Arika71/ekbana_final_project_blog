              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-plaintext text-muted">{{$user->gender}}</p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-plaintext text-muted">{{$user->contact}}</p>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-plaintext text-muted">{{$user->address}}</p>
                    </div>
                  </div>
                  <hr>
